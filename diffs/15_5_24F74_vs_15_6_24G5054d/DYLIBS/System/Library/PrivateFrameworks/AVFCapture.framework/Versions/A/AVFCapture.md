...
+ OBJC_IVAR_$_AVCaptureDALDevice._companionDeskViewDeviceUUID
...
+ "decompressorLastRenderErrorListener"
+ "depth data"
+ "description=CameraCapture_AVF-587.140.7"
+ "digraph %@ {\n"
+ "disconnected"
+ "dog body detection"
+ "dog head detection"
