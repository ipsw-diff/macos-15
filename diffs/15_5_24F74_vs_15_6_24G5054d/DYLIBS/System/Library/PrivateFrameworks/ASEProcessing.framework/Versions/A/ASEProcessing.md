...
CStrings:
+ " [1.41.51]     %s: src={ %dw x %dh }, dest={ %dw x %dh }, aseFunctionOnYesOffNo=%d\n"
+ " [1.41.51]     %s: src={ %dw x %dh }, dest={ %dw x %dh }, aseFunctionOnYesOffNo=%d, fps=%f\n"
+ " [1.41.51] %s : aseMeasurementOutput=%p, aseFrameProcessingControl=%p"
+ " [1.41.51] %s : bad argument, retVal=%ld, aseMeasurementOutput=%p, completionCallback=%p\n"
+ " [1.41.51] %s : config=%p"
+ " [1.41.51] %s : instance=%p, productType=%u, destinationWidth=%d,  destinationHeight=%d"
+ " [1.41.51] %s : unknownProcessingType=%d, strength=%f, wxh=%dx%d"
+ " [1.41.51] %s : unknownProcessingType=%d, strength=%f, wxh=%dx%d\n"
+ " [1.41.51] ++ %s: ASEApiVer=%d\n"
- "    %s: blendConfigV3Hcu:"
- "    %s: ebeConfigV3Hcu:"
...
- " [1.41.50]     %s: src={ %dw x %dh }, dest={ %dw x %dh }, aseFunctionOnYesOffNo=%d\n"
- " [1.41.50]     %s: src={ %dw x %dh }, dest={ %dw x %dh }, aseFunctionOnYesOffNo=%d, fps=%f\n"
...
- " [1.41.50] %s : aseMeasurementOutput=%p, aseFrameProcessingControl=%p\n"
- " [1.41.50] %s : bad argument, retVal=%ld, aseMeasurementOutput=%p, completionCallback=%p\n"
- " [1.41.50] %s : config=%p"
- " [1.41.50] %s : initX = %f, initY = %f, DDAInitX = 0x%x, DDAInitY = 0x%x, DDAStepX = 0x%x, DDAStepY = 0x%x, DDAInvStepX = 0x%x, DDAInvStepY = 0x%x\n"
- " [1.41.50] %s : instance=%p, productType=%u, destinationWidth=%d,  destinationHeight=%d"
- " [1.41.50] %s : unknownProcessingType=%d, strength=%f, wxh=%dx%d"
- " [1.41.50] %s : unknownProcessingType=%d, strength=%f, wxh=%dx%d\n"
