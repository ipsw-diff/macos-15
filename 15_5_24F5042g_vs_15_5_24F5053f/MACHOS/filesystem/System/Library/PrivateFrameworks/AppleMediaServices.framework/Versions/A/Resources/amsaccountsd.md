...
-  __DATA_CONST.__const: 0x10c28
+  __DATA_CONST.__auth_ptr: 0xb30
+  __DATA_CONST.__const: 0x10e08
...
-  __DATA.__objc_const: 0x7e18
-  __DATA.__objc_selrefs: 0x2ad8
+  __DATA.__objc_const: 0x7f78
+  __DATA.__objc_selrefs: 0x2b10
   __DATA.__objc_ivar: 0x2c0
-  __DATA.__objc_data: 0x1888
-  __DATA.__data: 0x6acc
-  __DATA.__bss: 0x1f160
-  __DATA.__common: 0x1fc
+  __DATA.__objc_data: 0x18d8
+  __DATA.__data: 0x6d54
+  __DATA.__bss: 0x1f960
...
CStrings:
+ "<%@: %p identifier = %@ | role = %ld | status = %ld"
+ "AMSDOnDeviceDataService"
+ "AMSOnDeviceDataServiceInterface"
+ "Error while removing data for account:"
+ "accountIdentity"
+ "afterDelay"
+ "askToSync:reply:"
+ "datasetName"
...
+ "handleAPICallWithSyncRequest:completionHandler:"
+ "idDomain"
+ "idSource"
+ "idSuffix"
+ "participantID"
...
+ "tsDataSyncLocalAPICall"
+ "v24@0:8@?<v@?@\"<AMSOnDeviceDataServiceInterface>\"@\"NSError\">16"
+ "v32@0:8@\"AMSOnDeviceDataSyncRequest\"16@?<v@?@\"NSError\">24"
+ "v32@0:8@\"AMSOnDeviceDataSyncRequest\"16@?<v@?B@\"NSError\">24"
+ "x-apple-ts-id-suffix"
- "<%@: %p name = %@ %@ | role = %ld | status = %ld"
- "familyName"
- "givenName"
- "handleAPICallWithPayload:completionHandler:"
- "nameComponents"
- "userIdentity"
```
