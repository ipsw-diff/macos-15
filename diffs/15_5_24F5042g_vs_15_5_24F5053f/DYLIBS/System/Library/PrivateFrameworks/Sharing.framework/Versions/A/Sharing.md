...
Symbols:
+ -[SFAuthenticationManager failedApproveSessionWithID:error:]
...
+ ___60-[SFAuthenticationManager failedApproveSessionWithID:error:]_block_invoke
+ ___block_descriptor_32_e30_v24?0"NSString"8"NSError"16l
+ _objc_msgSend$_resolveContactForPeerInfo:
+ _objc_msgSend$emailHash
+ _objc_msgSend$manager:didFailApproveForSessionWithID:error:
...
+ "Notifying client approve failed for %@ error: %@"
...
+ "setEmailHash:"
+ "setPhoneHash:"
- "displayNameForLocale: _nameComponents = nil, fall back to displayName: %@"
```
