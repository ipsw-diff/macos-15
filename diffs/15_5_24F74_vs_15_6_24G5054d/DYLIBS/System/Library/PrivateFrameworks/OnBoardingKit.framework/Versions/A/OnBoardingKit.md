...
Functions:
~ +[OBPrivacyFlow _splashPlistFromBundle:forContentName:] : 272 -> 436
~ -[OBPrivacyFlow _splashLocalizedStringForKey:language:preferredDeviceType:] : 236 -> 416
CStrings:
+ "-seed"
```
