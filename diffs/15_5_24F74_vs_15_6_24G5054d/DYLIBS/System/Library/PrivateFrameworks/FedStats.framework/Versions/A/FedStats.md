...
+ OBJC_IVAR_$_FedStatsDataEncoder._resultType
+ OBJC_IVAR_$_FedStatsHistogramType._clippingBound
+ OBJC_IVAR_$_FedStatsHistogramType._defaultFeatureFactor
+ OBJC_IVAR_$_FedStatsHistogramType._featureFactors
+ OBJC_IVAR_$_FedStatsHistogramType._featureField
+ OBJC_IVAR_$_FedStatsHistogramType._featureType
+ OBJC_IVAR_$_FedStatsHistogramType._metricField
+ OBJC_IVAR_$_FedStatsHistogramType._normDediscoTypeConfig
+ OBJC_IVAR_$_FedStatsHistogramType._normType
