...
-  __TEXT.__objc_methname: 0x2c462
+  __TEXT.__objc_methname: 0x2c3b8
...
-  __DATA_CONST.__objc_selrefs: 0x7d08
...
+ GCC_except_table93
+ _FigSignalErrorAt
+ __55-[AVCaptureFigVideoDevice _handleNotification:payload:]_block_invoke_9
...
- __102-[AVCaptureProprietaryDefaultsSingleton setObserveFrameSenderServerEndpoints:endpointsChangedHandler:]_block_invoke
- __104-[AVCaptureMovieFileOutput handleDidStopRecordingNotificationForWrapper:withPayload:demoof:addMetadata:]_block_invoke
- __115-[AVCaptureVideoPreviewLayer(_AVCaptureVideoPreviewLayerMetadataObjectDrawing) _setUpMetadataObjectLayerAttributes]_block_invoke
- __116+[AVCenterStageOnBoardingManager showCenterStageOnBoardingAlertIfNeededForTargetBundleIdentifier:completionHandler:]_block_invoke
- __122-[AVCaptureStillImageOutputUtils _newOrientationModifiedBufferForSampleBuffer:withRotationDegrees:imageMirrored:errorOut:]_block_invoke
- __132-[AVCaptureProprietaryDefaultsSingleton _handleDefaultChangedNotificationForKey:newValue:handlersForKeyObservers:callHandlersAsync:]_block_invoke
- __29+[AVCaptureSession dotString]_block_invoke
- __58-[AVCaptureFigVideoDevice setActiveVideoMinFrameDuration:]_block_invoke
- __66-[AVCaptureProprietaryDefaultsSingleton setObject:forWildcardKey:]_block_invoke
- __94-[AVCapturePhotoOutput commitMomentCaptureWithUniqueID:toMovieRecordingWithSettings:delegate:]_block_invoke
...
- setProperty
CStrings:
+ "description=CameraCapture_AVF-587.140.11.0.1"
- "\t%@ -> %@ [label=\"%@\\nenabled: %s\\nactive: %s\\norientation: %d\\nmirrored: %d\",color=%s];\n"
...
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/Sources/CameraCapture_AVF/AVFCapture/Common/Sources/AVCaptureCommon.m %s: could not determine proprietary defaults domain for %{private}@, so using unknown"
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/Sources/CameraCapture_AVF/AVFCapture/Common/Sources/AVCaptureCommon.m %s: not caching \"unknown\" proprietary defaults domain for %{private}@"
- ": %@"
...
- "decompressorLastRenderErrorListener"
- "depth data"
- "description=CameraCapture_AVF-587.140.9"
- "digraph %@ {\n"
- "disconnected"
- "dog body detection"
- "dog head detection"
