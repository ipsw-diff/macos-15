...
CStrings:
+ "<<<< VT-CS >>>> %s: Video encoders for this process will run %s"
+ "<<<< VT-DS >>>> %s: Video decoders for this process will run %s"
+ "<<<< VTTileCompressionSession >>>> %s: Video encoders for this process will run %s"
+ "<<<< VTTileDecompressionSession >>>> %s: Video decoders for this process will run %s"
